    ...
    <section className="my-12">
      <div className="container mx-auto px-4 text-left">
        ...
        <p className=" my-4 text-lg font-semibold">
          Welcome to Konjo Habesha Fashion!
        </p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of Konjo Habesha&apos;s Website, located at{" "}
          <a
        ...
        <p>
          ...
          conditions. Do not continue to use Konjo Habesha Fashion if you do not
        ...
        <p>
          ...
          et. Any use of the above terminology or other words in the singular,
        ...
        <p>
          We employ the use of cookies. By accessing Konjo Habesha Fashion, you
          agreed to use cookies in agreement with the Konjo Habesha&apos;s
          Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, Konjo Habesha and/or its licensors own the
          intellectual property rights for all material on Konjo Habesha
          Fashion. All intellectual property rights are reserved. You may access
          this from Konjo Habesha Fashion for your own personal use subjected to
          restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul className=" flex list-inside list-disc flex-col gap-2">
          <li>Republish material from Konjo Habesha Fashion</li>
          <li>Sell, rent or sub-license material from Konjo Habesha Fashion</li>
          <li>
            Reproduce, duplicate or copy material from Konjo Habesha Fashion
          </li>
          <li>Redistribute content from Konjo Habesha Fashion</li>
        </ul>
        ...
        <p>
          ...
          Konjo Habesha does not filter, edit, publish or review Comments prior
          to their presence on the website. Comments do not reflect the views
          and opinions of Konjo Habesha,its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Konjo Habesha
        ...
        <p>
          Konjo Habesha reserves the right to monitor all Comments and to remove
        ...
        <p>
          You hereby grant Konjo Habesha a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Konjo Habesha; and (d) the
        ...
        <p>
          ...
          sending an e-mail to Konjo Habesha. Please include your name, your
        ...
        <p>
          No use of Konjo Habesha&apos;s logo or other artwork will be allowed
